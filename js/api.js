            ...
            var articleHTML = `
              <div class="card">
                ...
                <div class="card-content">
                  ...
                  ${convert.makeHtml(data.result.post_content)}
                </div>
              </div>
            `;
            // Sisipkan komponen card ke dalam elemen dengan id #content
...
// mengambil seluruh artikel di Indexed DB melalui fungsi getAll() lalu menampilkannya
...
// getSavedArticleById yang mengambil data dari database dan menampilkannya di halaman detail.
  ...
  getById(idParam).then(function (article) {
    ...
    <div class="card">
      ...
      <div class="card-content">
        ...
        ${convert.makeHtml(article.post_content)}
      </div>
    </div>
  `;
    // Sisipkan komponen card ke dalam elemen dengan id #content
...
function isArticleSaved(id) {
  return getById(id).then(function (response) {
